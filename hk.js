...
//const emailpassObj = require("./secrets.txt");  // for future if i want to do more coding question using automation
...
browserStartPromise
    .then(function (browserObj) {
        ...
        let emailWillBeEnteredPromise = page.type("input[id='input-1']","gamibis240@enamelme.com" , { delay: 50 });
       return emailWillBeEnteredPromise;
    }).then(function () {
        let passwordWillBeEnteredPromise = page.type("input[type='password']", "pepcoding", { delay: 50 });
    ...
    .then(function () {
        let clickedOnAlgoPromise =
            waitAndClick('.topic-card a[data-cd-topic-slug="algorithms"]', page); //.track-card a[data-attr2='algorithms']
...
function waitAndClick(selector, cPage) {
    return new Promise(function (resolve, reject) {
        ...
        waitForModalPromise
            .then(function () {
                let clickModal =
                    cPage.click(selector, { delay: 200 });
                return clickModal;
            }).then(function () {
                resolve();
            }).catch(function (err) {
        ...
        qWillBeCLickedPromise
            ...
            .then(function () {
                ...
                let waitFOrEditorToBeInFocus =
                    waitAndClick(".monaco-editor.no-user-select.vs", page);// select
